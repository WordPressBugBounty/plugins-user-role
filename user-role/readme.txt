...
1. Roles page.
2. Edit administrator`s role page.
3. Edit subscriber`s role page.
4. Roles page for network admin panel.
...
= V1.6.9 - 10.07.2023 =
* Bugfix : Notice and Warnings issues have been fixed.
* Bugfix : Save Changes issue have been fixed.

= V1.6.8 - 21.04.2023 =
* Update : We updated all functionality for WordPress 6.2.
* Update : BWS Panel section was updated.
* Bugfix : Notice and Warnings issues have been fixed.
* Bugfix : Multisite issues have been fixed.

= V1.6.7 - 23.02.2022 =
* Update : We updated all functionality for WordPress 6.1.1.
* Update : BWS Panel section was updated.
...
* New : We added the ability to copy capabilities from another role.
